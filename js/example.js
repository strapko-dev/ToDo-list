const todo = {
    ...
    create(text) {
        return `<li class="todo__item" data-todo-state="active">
            ...
            <button class="todo__action todo__action_restore" data-todo-action="active">ACTIVE</button>
            <button class="todo__action todo__action_complete" data-todo-action="completed">COMPL</button>
            <button class="todo__action todo__action_delete" data-todo-action="deleted">DEL</button></li>`;
    },
    init() {
